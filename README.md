...
| Project | Description |
|----------|--------------|
|  [**ColoScreen AI**](https://github.com/SalmaLilad/ColoScreen) |Medical AI pipeline leveraging Generative AI (Stable Diffusion) and Bayesian inference to detect GI pathologies from 300k synthetic images.  |
