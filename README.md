...
|---------|-------------|------------|
| **[PneumonAI](https://github.com/SlmaLilad/PneumonAI)** (Stanford AIMI) | Multimodal pneumonia classifier (DenseNet-121 + ClinicalBERT late fusion) + Fast R-CNN localization + Grad-CAM + Bayesian CNN | **1st Place**, Swin-Tiny AUC **0.862**, multimodal accuracy up to **93%** |
